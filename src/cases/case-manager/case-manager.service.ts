...
export class CaseManagerService {
    ...
    async getDashboard(userId: string) {
        const [
            ...
            this.caseModel.countDocuments({
                workflowStatus:
                    CaseWorkflowStatus.LEGAL_REVIEW,
            }),

            this.caseModel.countDocuments({
                workflowStatus:
                    CaseWorkflowStatus.EXECUTED,
            }),
    ...
    async getStageSummary(userId: string) {
        return {
            ...
            readyForSignature:
                await this.caseModel.countDocuments({
                    workflowStatus:
                        CaseWorkflowStatus.READY_FOR_SIGNATURE,
                }),
    ...
    async approveCase(
        ...
        caseDoc.workflowStatus = CaseWorkflowStatus.COUPLE_SUBMITTED
    ...
    async uploadP1Confirmation(
        ...
        caseDoc.p1Confirmed = true;
        caseDoc.p1ConfirmedAt = new Date();
    ...
    async uploadP2Confirmation(
        ...
        caseDoc.p2Confirmed = true;
        caseDoc.p2ConfirmedAt = new Date();
